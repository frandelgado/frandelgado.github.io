...
With this said, I wanted to dig a little deeper and find anomalous spending logs, for this a boxplot was ideal. To be frank the only category to plot that brought some insight was the "Food & Drinks" Category which had a susbstantial ammount of entries. What was interesting about it is that I spend on average 334 ARS per meal, this taking into account the unhinged spending which took place on march 8th. 
